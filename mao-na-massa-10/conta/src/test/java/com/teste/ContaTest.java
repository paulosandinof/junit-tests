...
public class ContaTest {
    ...
    @Test
    public void testDebitarRetorno() throws OperacaoIlegalException {
        Conta conta = new Conta("123", 50);

        double saldo = conta.debitar(20);

        assertEquals(30, saldo, 0.0);
        assertEquals(30, conta.getSaldo(), 0.0);
    ...
    @Test
    public void testCreditarRetorno() throws OperacaoIlegalException {
        Conta conta = new Conta("123", 50);

        double saldo = conta.creditar(10);

        assertEquals(60, saldo, 0.0);
        assertEquals(60, conta.getSaldo(), 0.0);
        assertEquals(saldo, conta.getSaldo(), 0.0);
    }
